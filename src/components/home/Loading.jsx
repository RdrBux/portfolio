export default function Loading() {
  return (
    <div className="shadowed | group flex h-fit w-fit shrink-0 items-center gap-2 rounded-lg border border-black bg-white px-6 py-4 opacity-10 grayscale duration-300 hover:bg-violet-200 hover:opacity-100 hover:grayscale-0 lg:opacity-20">
