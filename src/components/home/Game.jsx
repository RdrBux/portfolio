...
export default function Game() {
  ...
  return (
    <div className="h-fit w-fit shrink-0 rounded-lg border border-black p-2 font-bold opacity-10 shadow-flat grayscale duration-300 hover:opacity-100 hover:grayscale-0 lg:opacity-20">
