export default function Comment() {
  return (
    <div className="w-60 shrink-0 animate-pulso select-none rounded-lg border border-black bg-white opacity-10 shadow-flat grayscale duration-300 animation-delay-6000  hover:animate-none hover:opacity-100 hover:grayscale-0">
