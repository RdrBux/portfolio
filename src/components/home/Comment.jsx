export default function Comment() {
  return (
    <div className="w-60 shrink-0 select-none rounded-lg border border-black bg-white opacity-10 shadow-flat grayscale duration-300 hover:opacity-100 hover:grayscale-0 lg:opacity-20">
