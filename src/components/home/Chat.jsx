...
export default function Chat() {
  ...
  return (
    <div className="w-48 shrink-0 animate-pulso rounded-lg bg-white opacity-10 shadow-flat grayscale duration-300 animation-delay-2000 hover:animate-none hover:opacity-100 hover:grayscale-0">
