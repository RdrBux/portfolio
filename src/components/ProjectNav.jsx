...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="fixed bottom-8 left-1/2 z-30 -ml-[164px] w-[328px] select-none rounded-full bg-black/75 font-cabinet text-[14px] text-white shadow-lg backdrop-blur-sm"
    >
      <motion.ul
        initial={{ opacity: 0 }}
